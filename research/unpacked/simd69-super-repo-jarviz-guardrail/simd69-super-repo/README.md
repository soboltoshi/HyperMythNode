...
JarViz interprets commands but does not validate beliefs. The shell now routes through a guardrail adapter before SIMD69 ordering. High-risk belief-confirmation prompts are converted into evidence requests instead of world mutations.

See:
- `docs/security/JARVIZ_GUARDRAIL_ADAPTER.md`
