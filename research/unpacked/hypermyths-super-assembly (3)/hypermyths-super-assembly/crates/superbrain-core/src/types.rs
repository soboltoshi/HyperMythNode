...
pub struct MarketSnapshot {
    ...
    pub asimog: AsimogProfile,
    pub clawmog: ClawmogProfile,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AsimogProfile {
    pub name: String,
    pub private_brain_role: String,
    pub public_brain_role: String,
    pub backend_role: String,
    pub market_charter: String,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ClawmogProfile {
    pub name: String,
    pub frontend_role: String,
    pub operator_shell_role: String,
    pub public_surface_role: String,
}
